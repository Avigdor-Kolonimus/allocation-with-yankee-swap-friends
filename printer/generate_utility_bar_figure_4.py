...
# Load CSV files
df_dsa_rc = pd.read_csv('example_utility_figure_2.csv')
df_ys = pd.read_csv('example_utility_figure_2_ys.csv')
...
for weight in [0, 1, 2, 3, 4, 5]:
    ...
    # Display plot
    plt.title(f'Comparison of utility results for friendship weight set to {weight}')
