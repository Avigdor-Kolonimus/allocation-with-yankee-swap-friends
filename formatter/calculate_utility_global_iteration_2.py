...
total_output = 'C:\\Users\\superup\\yankee_swap_2\\formatter\\accumulate\\total_output_o_t_r.csv'
global_total_output = 'C:\\Users\\superup\\yankee_swap_2\\formatter\\accumulate\\global_total_output_o_t_r.csv'
fw = 1
...
global_csv_base_0=0
global_csv_base_dsa_rc=1

global_input_original=1
global_input_third=0
global_input_rnd=0
...
def write_global_row(total_utility, gini, num_exp, course_limit):
    row ={
        ...
        'input_original':global_input_original,
        'input_third':global_input_third,
        'input_rnd':global_input_rnd,
        'cl_60':0,
        'cl_90':0, 
        'friendship_w_0':0, 
        'friendship_w_1':0
    ...
    match global_csv_method:
        ...
        case 5:
            row['utility_YS_rnd'] = total_utility
            row['gini_YS_rnd'] = gini
...
for folder_name in folders:
    ...
    if os.path.isdir(folder_path):
        ...
        with open(global_total_output, mode='a', newline='') as csvfile:
            fieldnames = ['exp#', 'utility_YS', 'utility_YS_order', 'utility_YS_course', 'utility_YS_both', 'utility_YS_rnd', 'gini_YS', 'gini_YS_order', 'gini_YS_course', 'gini_YS_both', 'gini_YS_rnd',
                          'base_0', 'base_DSA_RC', 'input_original', 'input_third', 'input_rnd', 'cl_60', 'cl_90', 'friendship_w_0', 'friendship_w_1']
            ...
            for csv_file in csv_files:
                ...
                with open(csv_file_path, 'r') as file:
                    for index_student, line in enumerate(file, start=0):
                        elements = line.strip().split(',')
                        array_representation = np.array(elements, dtype=int)
